...
export async function resolveClientRuntimeConfig(projectRoot, networkInput, env = process.env, overrides = {}) {
    ...
    const envOverrides = useEnvOverrides
        ? {
